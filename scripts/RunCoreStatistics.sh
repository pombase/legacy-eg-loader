...
# 5. Set pipeline name
pipeline_name=core_statistics_${ENSEMBL_RELEASE}
...
init_pipeline.pl Bio::EnsEMBL::EGPipeline::PipeConfig::CoreStatistics_conf -registry ${registry} -species schizosaccharomyces_pombe $($DBHIVECMD details script) -pipeline_dir ${pipeline_dir} -no_pepstats 1
